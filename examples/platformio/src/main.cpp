...
void setup() {
  ...
  // Plantower, Panasonic) sensors.init(sensors.Panasonic);             // Force UART detection to
  // Panasonic sensor sensors.init(sensors.Sensirion);             // Force UART detection to
  // Sensirion sensor sensors.init(sensors.Mhz19);                 // Force UART detection to Mhz14
  // or Mhz19 CO2 sensor sensors.init(sensors.SDS011);                // Force UART detection to
  // SDS011 sensor sensors.init(sensors.CM1106);                // Force UART detection to CM1106
  // CO2 sensor sensors.init(sensors.SENSEAIRS8);            // Force UART detection to SenseAirS8
  // CO2 sensor sensors.init(sensors.Auto,PMS_RX,PMS_TX);    // Auto detection on custom RX,TX
}
